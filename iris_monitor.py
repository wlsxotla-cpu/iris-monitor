...
ALL_MINISTRIES = {
    "1":  ("범부처",             "AR4999", "#455a64"),
    "2":  ("과학기술정보통신부", "AR4001", "#1a6fc4"),
    "3":  ("산업통상부",         "AR4002", "#c45c1a"),
    "4":  ("중소벤처기업부",     "AR4003", "#1a9e52"),
    "5":  ("국토교통부",         "AR4004", "#7b1fa2"),
    "6":  ("교육부",             "AR4005", "#00796b"),
    "7":  ("기상청",             "AR4006", "#0288d1"),
    "8":  ("농림축산식품부",     "AR4007", "#558b2f"),
    "9":  ("농촌진흥청",         "AR4008", "#33691e"),
    "10": ("국가유산청",         "AR4009", "#6d4c41"),
    "11": ("문화체육관광부",     "AR4010", "#ad1457"),
    "12": ("방위사업청",         "AR4011", "#37474f"),
    "13": ("보건복지부",         "AR4012", "#c62828"),
    "14": ("산림청",             "AR4013", "#2e7d32"),
    "15": ("식품의약품안전처",   "AR4014", "#ef6c00"),
    "16": ("원자력안전위원회",   "AR4015", "#4527a0"),
    "17": ("해양수산부",         "AR4016", "#0277bd"),
    "18": ("행정안전부",         "AR4017", "#00695c"),
    "19": ("기후에너지환경부",   "AR4018", "#1b5e20"),
    "20": ("우주항공청",         "AR4019", "#1a237e"),
    "21": ("방송미디어통신위원회","AR4021", "#880e4f"),
    "22": ("법무부",             "AR4902", "#4e342e"),
    "23": ("국방부",             "AR4903", "#263238"),
    "24": ("고용노동부",         "AR4904", "#e65100"),
    "25": ("경찰청",             "AR4908", "#1565c0"),
    "26": ("재정경제부",         "AR4911", "#4a148c"),
    "27": ("소방청",             "AR4915", "#b71c1c"),
    "28": ("해양경찰청",         "AR4916", "#01579b"),
    "29": ("관세청",             "AR4930", "#827717"),
    "30": ("조달청",             "AR4932", "#33691e"),
    "31": ("질병관리청",         "AR4933", "#880e4f"),
    "32": ("개인정보보호위원회", "AR4981", "#4527a0"),
    "33": ("국민안전처",         "AR4986", "#bf360c"),
    "34": ("대통령경호처",       "AR4988", "#212121"),
}
